...
<form class="layui-form" lay-filter="form_role">
 <div class="layui-form-item">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
    <!-- lay-verify="required"的检验 -->
      <input type="text" name="roleName" required  lay-verify="required|checkrolename" placeholder="请输入角色称 " autocomplete="off" class="layui-input">
    </div>
  </div>
   <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <textarea name="roleInfo" placeholder="请输入角色信息" class="layui-textarea"></textarea>
    </div>
  </div>
